...
import service.player.implementation.PlayerMainFunImple;
import service.search.PlayerSearchService;
import service.search.implementation.PlayerSearchServiceImpl;
...
public class PlayerMain {
	...
	public static void main(String[] args) {
		...
		PropertyConfigurator.configure(log4jConfPath);
	        ...
	        PlayerMainFunc playerMainFunctionality = new PlayerMainFunImple();
